  ...
  var result = `
    <div class="row paginate">
      ...
      <div class="card small">
        ...
        <select param name="page" onchange="API.setUrlParam('page', $(this).val());setTimeout(async () => { Render.try('main',  null, true); }, 150)">
          ${pages}
        </select>
      </div>
      ...
      <div class="card small" style="width: 120px;">
        ...
        <select param name="per" onchange="API.setUrlParam('per', $(this).val());setTimeout(async () => { await Render.try('main',  null, true); }, 150)">
